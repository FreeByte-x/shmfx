...
|---|-------|-------------|-----------|----------------------|
| 1 | Core Design Document | `docs/vi/01_DESIGN.md` (framework chuẩn) + `docs/vi/03_LOGGING_APP.md` (reference app riêng) | 1 lượt | ✅ |
...
5. **Khi mở session mới**, user chỉ cần nói:
   > "Đọc `/apps/source/sharemem/docs/vi/PLAN.md`, tiếp tục Phase N."
...
11. Reference apps
    ...
    11.2 Distributed Logging xem `docs/vi/03_LOGGING_APP.md`
...
- [x] Phase 1 – Core design (`docs/vi/01_DESIGN.md`) + logging app design (`docs/vi/03_LOGGING_APP.md`)
...
- "Tiếp tục Phase 1" → Claude đọc `docs/vi/PLAN.md` rồi viết design doc.
