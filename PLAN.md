...
|---|-------|-------------|-----------|----------------------|
| 1 | Core Design Document | `docs/01_DESIGN.md` (framework chuẩn) + `docs/05_LOGGING_APP.md` (reference app riêng) | 1 lượt | ✅ |
...
│   ├── 04_OPEN_ISSUES.md           # Cross-cutting backlog
│   └── 05_LOGGING_APP.md           # Reference logging app design
├── include/shmfx/
│   ├── shm_error.h                 # Phase 2
...
| Ngôn ngữ | C++20 (nâng từ C++17 theo `docs/02_DESIGN_REVIEW`; cho phép `std::span`, `<concepts>`, `<bit>`) |
...
11. Reference apps
    ...
    11.2 Distributed Logging xem `docs/05_LOGGING_APP.md`
...
- [x] Phase 1 – Core design (`docs/01_DESIGN.md`) + logging app design (`docs/05_LOGGING_APP.md`)
